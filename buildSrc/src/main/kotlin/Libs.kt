object Libs {
    ...
    const val firebase_perf = "com.google.firebase:firebase-perf:19.0.2"
    ...
    const val androidx_room_runtime = "androidx.room:room-runtime:2.2.1"
    const val androidx_room_compiler = "androidx.room:room-compiler:2.2.1"
