object Libs {
    ...
    const val firebase_ads = "com.google.firebase:firebase-ads:19.7.0"
    const val firebase_analytics = "com.google.firebase:firebase-analytics:18.0.2"
    const val firebase_auth = "com.google.firebase:firebase-auth:20.0.3"
    ...
    const val firebase_config = "com.google.firebase:firebase-config:20.0.4"
    const val firebase_database = "com.google.firebase:firebase-database:19.7.0"
    const val firebase_dynamic_links = "com.google.firebase:firebase-dynamic-links:19.1.1"
    const val firebase_perf = "com.google.firebase:firebase-perf:19.1.1"
    const val firebase_messaging = "com.google.firebase:firebase-messaging:21.0.1"
    const val firebase_crashlytics = "com.google.firebase:firebase-crashlytics:17.4.0"
